...
DEFAULT_PARSER_DIR = _REPO_ROOT / "frontend" / "src" / "utils" / "parser"
...
def autostart_enabled() -> bool:
    """Автозапуск можно выключить, оставив ручной режим."""
...
def _find_python(parser_dir: Path) -> str | None:
    ...
    candidates = [
        parser_dir / ".venv" / "bin" / "python",       # macOS / Linux
        parser_dir / ".venv" / "Scripts" / "python.exe",  # Windows
