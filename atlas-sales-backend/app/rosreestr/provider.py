...
class RosreestrParserProvider:
    def __init__(self, fallback: PropertyDataProvider | None = None):
        self._fallback = fallback or DemoPropertyProvider()

    def lookup_by_address(self, query: str) -> PropertyLookupResult | None:
        return self._fallback.lookup_by_address(query)

    def lookup_by_id(self, property_id: int) -> PropertyLookupResult | None:
        return self._fallback.lookup_by_id(property_id)
