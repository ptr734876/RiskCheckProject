              ...
              <div>
                ...
                <div className="flex items-start gap-2 mt-2">
                  ...
                  <p className="text-xs text-blue-800 leading-relaxed">
                    Перед совершением сделки сверяйтесь с актуальным законодательством и при необходимости обратитесь за квалифицированной юридической помощью к нам по горячей линии (+7 ххх ххх хх хх).
                  </p>
                </div>
              </div>
            </div>
