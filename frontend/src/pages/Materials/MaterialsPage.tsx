            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm text-blue-900 font-medium leading-relaxed">
                  Материал соответствует законодательству РФ на дату публикации (28.07.2026). 

                </p>
                <div className="flex items-start gap-2 mt-2">
                  <AlertCircle className="w-4 h-4 text-amber-600 flex-shrink-0 mt-0.5" />
                  <p className="text-xs text-blue-800 leading-relaxed">
                    Перед совершением сделки сверяйтесь с актуальным законодательством и при необходимости обратитесь за квалифицированной юридической помощью к нам по номеру телефона горячей линии (+7 ххх ххх хх хх).
                  </p>
                </div>
              </div>
            </div>
